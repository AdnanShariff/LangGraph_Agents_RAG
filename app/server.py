...
documents = []
with open('crawled_docs/crawl_documents.jsonl', 'r') as f:
    for line in f:
...
workflow.add_node("grade_documents", graph_nodes.grade_documents)  # grade documents , retrieval grader
...
app = FastAPI(
    title="CTG Chatbot",
    version="1.0",
    description="An API server to answer questions regarding Documentation"  
)
