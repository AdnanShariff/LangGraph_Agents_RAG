...
def create_generate_chain(llm):
    ...
    """
    generate_template = """
    You are a helpful code assistant named CTG. The user provides you with a code-related question whose content is represented by the following context parts (delimited by <context></context>).
    Use these to answer the question at the end.
    The files deal with Developer Documentation. You can assume that the user is either a software developer or technical enthusiast.
